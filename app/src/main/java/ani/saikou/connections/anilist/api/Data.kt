...
//    }
    ...
    data class CombinedMediaListResponse(
        ...
        @Serializable
        data class Data(
            @SerialName("current") val current: ani.saikou.connections.anilist.api.MediaListCollection?,
            @SerialName("planned") val planned: ani.saikou.connections.anilist.api.MediaListCollection?,
            @SerialName("repeating") val repeating: ani.saikou.connections.anilist.api.MediaListCollection?,
        )
    }
    ...
    data class HomePageMedia(
        ...
        @Serializable
        data class Data(
            @SerialName("currentAnime") val currentAnime: ani.saikou.connections.anilist.api.MediaListCollection?,
            @SerialName("repeatingAnime") val repeatingAnime: ani.saikou.connections.anilist.api.MediaListCollection?,
            @SerialName("favoriteAnime") val favoriteAnime: ani.saikou.connections.anilist.api.User?,
            @SerialName("plannedAnime") val plannedAnime: ani.saikou.connections.anilist.api.MediaListCollection?,
            @SerialName("currentManga") val currentManga: ani.saikou.connections.anilist.api.MediaListCollection?,
            @SerialName("repeatingManga") val repeatingManga: ani.saikou.connections.anilist.api.MediaListCollection?,
            @SerialName("favoriteManga") val favoriteManga: ani.saikou.connections.anilist.api.User?,
            @SerialName("plannedManga") val plannedManga: ani.saikou.connections.anilist.api.MediaListCollection?,
            @SerialName("recommendationQuery") val recommendationQuery: ani.saikou.connections.anilist.api.Page?,
            @SerialName("recommendationPlannedQueryAnime") val recommendationPlannedQueryAnime: ani.saikou.connections.anilist.api.MediaListCollection?,
            @SerialName("recommendationPlannedQueryManga") val recommendationPlannedQueryManga: ani.saikou.connections.anilist.api.MediaListCollection?,
        )
    }
    ...
    data class ProfilePageMedia(
        ...
        data class Data(
            @SerialName("favoriteAnime") val favoriteAnime: ani.saikou.connections.anilist.api.User?,
            @SerialName("favoriteManga") val favoriteManga: ani.saikou.connections.anilist.api.User?,
            @SerialName("animeMediaList") val animeMediaList: ani.saikou.connections.anilist.api.MediaListCollection?,
            @SerialName("mangaMediaList") val mangaMediaList: ani.saikou.connections.anilist.api.MediaListCollection?
        )
    }
    ...
    data class FollowerPage(
        ...
        val followers: List<ani.saikou.connections.anilist.api.User>?
    ) : java.io.Serializable

    @Serializable
    data class FollowingPage(
        @SerialName("following")
        val following: List<ani.saikou.connections.anilist.api.User>?
    ) : java.io.Serializable
