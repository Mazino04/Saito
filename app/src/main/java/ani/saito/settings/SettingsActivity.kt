...
import ani.saito.BuildConfig
import ani.saito.R
import ani.saito.Refresh
import ani.saito.connections.anilist.Anilist
import ani.saito.connections.anilist.api.NotificationType
...
import ani.saito.databinding.ActivitySettingsBinding
import ani.saito.download.DownloadedType
import ani.saito.download.DownloadsManager
import ani.saito.download.video.ExoplayerDownloadService
import ani.saito.downloadsPermission
...
import ani.saito.notifications.subscription.SubscriptionNotificationWorker.Companion.checkIntervals
import ani.saito.openLinkInBrowser
import ani.saito.openSettings
import ani.saito.others.AppUpdater
import ani.saito.others.CustomBottomDialog
import ani.saito.savePrefsToDownloads
...
import ani.saito.settings.saving.internal.Location
import ani.saito.settings.saving.internal.PreferenceKeystore
import ani.saito.settings.saving.internal.PreferencePackager
...
class SettingsActivity : AppCompatActivity(), SimpleDialog.OnDialogResultListener {
    ...
    companion object {
        fun getDeviceInfo(): String {
            return """
                saito Version: ${BuildConfig.VERSION_NAME}
                Device: $BRAND $DEVICE
