...
import ani.saito.connections.anilist.AnilistHomeViewModel
import ani.saito.databinding.ActivityMainBinding
import ani.saito.databinding.SplashScreenBinding
...
import ani.saito.settings.saving.PrefManager.asLiveBool
import ani.saito.settings.saving.PrefName
import ani.saito.settings.saving.SharedPreferenceBooleanLiveData
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                    if (!(PrefManager.getVal(PrefName.AllowOpeningLinks) as Boolean)) {
                        CustomBottomDialog.newInstance().apply {
                            title = "Allow Saito to automatically open Anilist & MAL Links?"
