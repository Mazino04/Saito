...
import ani.saito.*
import ani.saito.databinding.FragmentAnimeWatchBinding
import ani.saito.download.DownloadedType
import ani.saito.download.DownloadsManager
import ani.saito.download.manga.MangaDownloaderService
import ani.saito.download.manga.MangaServiceDataSingleton
import ani.saito.media.Media
import ani.saito.media.MediaDetailsActivity
import ani.saito.media.MediaDetailsViewModel
import ani.saito.media.manga.mangareader.ChapterLoaderDialog
import ani.saito.others.LanguageMapper
import ani.saito.parsers.DynamicMangaParser
import ani.saito.parsers.HMangaSources
import ani.saito.parsers.MangaParser
import ani.saito.parsers.MangaSources
import ani.saito.settings.extensionprefs.MangaSourcePreferencesFragment
import ani.saito.settings.saving.PrefManager
import ani.saito.settings.saving.PrefName
import ani.saito.notifications.subscription.SubscriptionHelper
import ani.saito.notifications.subscription.SubscriptionHelper.Companion.saveSubscription
