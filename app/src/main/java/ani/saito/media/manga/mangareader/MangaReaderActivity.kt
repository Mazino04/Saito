package ani.saito.media.manga.mangareader
...
import ani.saito.connections.discord.Discord
import ani.saito.connections.discord.DiscordService
import ani.saito.connections.discord.DiscordServiceRunningSingleton
import ani.saito.connections.discord.RPC
import ani.saito.connections.updateProgress
import ani.saito.databinding.ActivityMangaReaderBinding
import ani.saito.media.Media
import ani.saito.media.MediaDetailsViewModel
import ani.saito.media.MediaSingleton
import ani.saito.media.manga.MangaCache
import ani.saito.media.manga.MangaChapter
import ani.saito.media.manga.MangaNameAdapter
import ani.saito.others.ImageViewDialog
import ani.saito.parsers.HMangaSources
import ani.saito.parsers.MangaImage
import ani.saito.parsers.MangaSources
import ani.saito.settings.CurrentReaderSettings
import ani.saito.settings.CurrentReaderSettings.Companion.applyWebtoon
import ani.saito.settings.CurrentReaderSettings.Directions.*
import ani.saito.settings.CurrentReaderSettings.DualPageModes.*
import ani.saito.settings.CurrentReaderSettings.Layouts.*
