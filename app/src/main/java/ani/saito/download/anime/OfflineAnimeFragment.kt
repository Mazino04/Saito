package ani.saito.download.anime
...
import ani.saito.settings.SettingsDialogFragment
...
class OfflineAnimeFragment : Fragment(), OfflineAnimeSearchListener {
        ...
        gridView.setOnItemLongClickListener { _, _, position, _ ->
            ...
            builder.setPositiveButton("Yes") { _, _ ->
                ...
                for (mediaId in mediaIds) {
                    ani.saito.download.video.Helper.downloadManager(requireContext())
    ...
    private fun getMedia(downloadedType: DownloadedType): Media? {
        ...
        val directory = File(
            ...
            "Saito/$type/${downloadedType.title}"
        )
