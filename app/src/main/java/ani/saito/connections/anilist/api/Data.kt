package ani.saito.connections.anilist.api
...
class Query {
    ...
    data class Viewer(
        ...
        data class Data(
            @SerialName("Viewer")
            val user: ani.saito.connections.anilist.api.User?
        )
    }
    ...
    data class Media(
        ...
        data class Data(
            @SerialName("Media")
            val media: ani.saito.connections.anilist.api.Media?
        )
    }
    ...
    data class Page(
        ...
        data class Data(
            @SerialName("Page")
            val page: ani.saito.connections.anilist.api.Page?
        )
    }
...
//    }
    ...
    data class Character(
        ...
        data class Data(
            ...
            val character: ani.saito.connections.anilist.api.Character?
        )
    }
    ...
    data class Studio(
        ...
        data class Data(
            @SerialName("Studio")
            val studio: ani.saito.connections.anilist.api.Studio?
        )
    }
...
//    }
    ...
    data class MediaListCollection(
        ...
        data class Data(
            ...
            val mediaListCollection: ani.saito.connections.anilist.api.MediaListCollection?
        )
    }
    ...
    data class CombinedMediaListResponse(
        ...
        @Serializable
        data class Data(
            @SerialName("current") val current: ani.saito.connections.anilist.api.MediaListCollection?,
            @SerialName("planned") val planned: ani.saito.connections.anilist.api.MediaListCollection?,
            @SerialName("repeating") val repeating: ani.saito.connections.anilist.api.MediaListCollection?,
        )
    }
    ...
    data class HomePageMedia(
        ...
        @Serializable
        data class Data(
            @SerialName("currentAnime") val currentAnime: ani.saito.connections.anilist.api.MediaListCollection?,
            @SerialName("repeatingAnime") val repeatingAnime: ani.saito.connections.anilist.api.MediaListCollection?,
            @SerialName("favoriteAnime") val favoriteAnime: ani.saito.connections.anilist.api.User?,
            @SerialName("plannedAnime") val plannedAnime: ani.saito.connections.anilist.api.MediaListCollection?,
            @SerialName("currentManga") val currentManga: ani.saito.connections.anilist.api.MediaListCollection?,
            @SerialName("repeatingManga") val repeatingManga: ani.saito.connections.anilist.api.MediaListCollection?,
            @SerialName("favoriteManga") val favoriteManga: ani.saito.connections.anilist.api.User?,
            @SerialName("plannedManga") val plannedManga: ani.saito.connections.anilist.api.MediaListCollection?,
            @SerialName("recommendationQuery") val recommendationQuery: ani.saito.connections.anilist.api.Page?,
            @SerialName("recommendationPlannedQueryAnime") val recommendationPlannedQueryAnime: ani.saito.connections.anilist.api.MediaListCollection?,
            @SerialName("recommendationPlannedQueryManga") val recommendationPlannedQueryManga: ani.saito.connections.anilist.api.MediaListCollection?,
        )
    }
    ...
    data class ProfilePageMedia(
        ...
        data class Data(
            @SerialName("favoriteAnime") val favoriteAnime: ani.saito.connections.anilist.api.User?,
            @SerialName("favoriteManga") val favoriteManga: ani.saito.connections.anilist.api.User?,
            @SerialName("animeMediaList") val animeMediaList: ani.saito.connections.anilist.api.MediaListCollection?,
            @SerialName("mangaMediaList") val mangaMediaList: ani.saito.connections.anilist.api.MediaListCollection?
        )
    }
    ...
    data class FollowerPage(
        ...
        val followers: List<ani.saito.connections.anilist.api.User>?
    ) : java.io.Serializable

    @Serializable
    data class FollowingPage(
        @SerialName("following")
        val following: List<ani.saito.connections.anilist.api.User>?
    ) : java.io.Serializable
